  ...
  return new Promise((resolve, reject) =>{
   ...
   //console.log('人民币汇率' + data)
    try{
      ...
      $.detail = "        🇺🇸 1 美元 <==> 🇨🇳 "+(1/result.data[1].rate).toFixed(3)+" 元\n"+"        🇯🇵 1 日元 <==> 🇨🇳 "+(1/result.data[2].rate).toFixed(3)+" 元\n"+"        🇭🇰 1 港币 <==> 🇨🇳 "+(1/result.data[9].rate).toFixed(3)+" 元\n"+"        🇬🇧 1 英镑 <==> 🇨🇳 "+(1/result.data[3].rate).toFixed(3)+" 元\n"+"        🇪🇺 1 欧元 <==> 🇨🇳 "+(1/result.data[4].rate).toFixed(3)+" 元\n"
      $.subTitle = '今日汇率: '
     }
       catch (erro){
