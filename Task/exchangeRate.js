  ...
  return new Promise((resolve, reject) =>{
   ...
   //console.log('人民币汇率' + data)
    try{
      ...
      //$.detail = "  🇺🇸 "+result.data[1].code+ result.data[1].symbol+" 1 美元 <==> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/USTOCN).toFixed(3)+" 元\n"+"  🇯🇵 "+result.data[2].code+ result.data[2].symbol+" 1 日元 <==> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/JPTOCN).toFixed(3)+" 元\n"+"  🇭🇰 "+result.data[9].code+ result.data[1].symbol+" 1 港币 <==> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/HKTOCN).toFixed(3)+" 元\n"+"  🇬🇧 "+result.data[3].code+ result.data[3].symbol+" 1 英镑 <==> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/GBTOCN).toFixed(3)+" 元\n"+"  🇪🇺 "+result.data[4].code+ result.data[4].symbol+" 1 欧元 <==> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/EUTOCN).toFixed(3)+" 元\n"
      //$.detail = "  🇺🇸 "+result.data[1].code+ result.data[1].symbol+" 1 美元 <=> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/result.data[1].rate).toFixed(3)+" 元\n"+"  🇯🇵 "+result.data[2].code+ result.data[2].symbol+" 1 日元 <=> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/result.data[2].rate).toFixed(3)+" 元\n"+"  🇭🇰 "+result.data[9].code+ result.data[1].symbol+" 1 港币 <=> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/result.data[9].rate).toFixed(3)+" 元\n"+"  🇬🇧 "+result.data[3].code+ result.data[3].symbol+" 1 英镑 <=> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/result.data[3].rate).toFixed(3)+" 元\n"+"  🇪🇺 "+result.data[4].code+ result.data[4].symbol+" 1 欧元 <=> 🇨🇳 "+ result.data[0].code+result.data[0].symbol+" "+(1/result.data[4].rate).toFixed(3)+" 元\n"
      $.detail = "    🇺🇸 1 美元 == 🇨🇳 "+(1/result.data[1].rate).toFixed(3)+" 人民币\n"+"    🇯🇵 1 日元 == 🇨🇳 "+(1/result.data[2].rate).toFixed(3)+" 人民币\n"+"    🇭🇰 1 港币 == 🇨🇳 "+(1/result.data[9].rate).toFixed(3)+" 人民币\n"+"    🇬🇧 1 英镑 == 🇨🇳 "+(1/result.data[3].rate).toFixed(3)+" 人民币\n"+"    🇪🇺 1 欧元 == 🇨🇳 "+(1/result.data[4].rate).toFixed(3)+" 人民币\n"
      $.subTitle = '今日汇率: '
     }
       catch (erro){
